...
void Mars::loadDiffuseTexture(std::string_view path) {
...
void Mars::loadFromFile(std::string_view path, bool standardize) {
...
void Mars::render(int numTriangles) const {
...
void Mars::setupVAO(GLuint program) {
